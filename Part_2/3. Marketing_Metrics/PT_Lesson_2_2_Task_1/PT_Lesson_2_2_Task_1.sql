...
campaign AS 
    (
    SELECT COUNT(DISTINCT user_id) AS count_new_users,
           CASE
...
SELECT campaign.ads_campaign,
       CASE
       WHEN campaign.ads_campaign = 'Кампания № 1' THEN ROUND(250000 / campaign.count_new_users ::numeric, 2)
       WHEN campaign.ads_campaign = 'Кампания № 2' THEN ROUND(250000 / campaign.count_new_users ::numeric, 2)
       END AS cac
FROM campaign
GROUP BY campaign.ads_campaign, campaign.count_new_users
ORDER BY cac DESC;
