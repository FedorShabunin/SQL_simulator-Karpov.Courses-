...
SELECT campaign.ads_campaign,
       CASE
       WHEN campaign.ads_campaign = 'Кампания № 1' THEN ROUND(100 * (SUM(products.price) - 250000) / 250000 ::numeric, 2)
       WHEN campaign.ads_campaign = 'Кампания № 2' THEN ROUND(100 * (SUM(products.price) - 250000) / 250000 ::numeric, 2)
       END AS roi
FROM campaign
    LEFT JOIN products
    USING(product_id)
